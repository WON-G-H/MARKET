...
function bind(container){
 ...
 let pinned=false;
 const hide=()=>{if(tip.matches(':popover-open'))tip.hidePopover();tip.hidden=true;pinned=false;container.querySelectorAll('.fm-active').forEach(el=>el.classList.remove('fm-active'));};
