...
assert(nodes.content.innerHTML.includes('data-log="2026-09-10"'));
...
context.location.hash='#calendar';handlers.hashchange();
assert(nodes.content.innerHTML.includes('PPI'));
assert(nodes.content.innerHTML.includes('ECB 기준금리 결정'));
assert(nodes.content.innerHTML.includes('Oracle FY2027 1분기 실적'));
